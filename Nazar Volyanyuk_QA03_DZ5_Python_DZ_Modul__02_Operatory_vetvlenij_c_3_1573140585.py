...
if (operator_out == 1 and operator_in == 1) or (operator_out == 2 and operator_in == 2) or (operator_out == 3 and operator_in == 3):
    print("стоимость 1 мин. разговора составляет", float(count_money) * 1, "грн/мин")
elif (operator_out == 1 and operator_in <= 3) or (operator_out == 2 and operator_in <= 3) or (operator_out == 3 and operator_in <= 3):
    print("стоимость 1 мин. разговора составляет", float(count_money) * 1.75, "грн/мин")
else:
...
manager1_sales = int(input("Введите уровень продаж 1 менеджера: "))
...
manager2_sales = int(input("Введите уровень продаж 2 менеджера: "))
...
manager3_sales = int(input("Введите уровень продаж 3 менеджера: "))
...
if manager1_sales > manager2_sales and manager1_sales > manager3_sales:
    print("Менеджер 1 лучший в продажах, премия +200$. ЗП = ", sales1_count + 200, "$\nменеджер 2 = ", sales2_count, "$\nменеджер 3 = ", sales3_count, "$")
elif manager2_sales > manager1_sales and manager2_sales > manager3_sales:
    print("Менеджер 1 = ", sales1_count, "$\nМенеджер 2 лучший в продажах, премия +200$. ЗП = ", sales2_count + 200, "$\nменеджер 3 = ", sales3_count, "$")
elif manager3_sales > manager1_sales and manager3_sales > manager2_sales:
    print("Менеджер 1 = ", sales1_count, "$\nМенеджер 2 = ", sales2_count, "$\nМенеджер 3 лучший в продажах, премия +200$. ЗП = ", sales3_count + 200, "$")
else:
    print("Менеджер 1 = ", sales1_count + 200, "$\nменеджер 2 = ", sales2_count, "$\nменеджер 3 = ", sales3_count, "$")